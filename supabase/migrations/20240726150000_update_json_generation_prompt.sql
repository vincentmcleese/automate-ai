-- Update the 'json_generation' prompt to include the selected tools,
-- giving the AI more context to generate a more accurate n8n workflow.
UPDATE public.system_prompts
SET
  prompt_text = '# 🏗️ n8n Workflow Builder – Authoring Prompt
...
WHERE id = (
  SELECT id FROM public.system_prompts
